...
var parse_headers = __webpack_require__(26935);
...
var src = __webpack_require__(6060);
...
var cjs = __webpack_require__(5032);
...
class AssetsClient {
    ...
    upload(assetType, body, options) {
        ...
        return (0,cjs.lastValueFrom)(observable.pipe((0,operators/* filter */.hX)((event)=>event.type === "response"), (0,operators/* map */.UI)((event)=>event.body.document)));
    }
}
...
function _listen(query, params) {
    ...
    return new cjs.Observable((observer)=>{
        ...
        async function getEventSource() {
            const { default: EventSource } = await __webpack_require__.e(/* import() */ 626).then(__webpack_require__.t.bind(__webpack_require__, 49626, 19));
...
const _SanityClient = class _SanityClient {
   ...
   */ withConfig(newConfig) {
    ...
    fetch(query, params) {
        let options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        return (0,cjs.lastValueFrom)(_fetch(this, index_browser_privateGet(this, _httpRequest2), query, params, options));
    }
    /**
   * Fetch a single document with the given ID.
   *
   ...
   * @param options - Request options
   */ getDocument(id, options) {
        return (0,cjs.lastValueFrom)(_getDocument(this, index_browser_privateGet(this, _httpRequest2), id, options));
    }
    /**
   * Fetch multiple documents in one request.
   * Should be used sparingly - performing a query is usually a better option.
   ...
   * @param options - Request options
   */ getDocuments(ids, options) {
        return (0,cjs.lastValueFrom)(_getDocuments(this, index_browser_privateGet(this, _httpRequest2), ids, options));
    }
    create(document, options) {
        return (0,cjs.lastValueFrom)(_create(this, index_browser_privateGet(this, _httpRequest2), document, "create", options));
    }
    createIfNotExists(document, options) {
        return (0,cjs.lastValueFrom)(_createIfNotExists(this, index_browser_privateGet(this, _httpRequest2), document, options));
    }
    createOrReplace(document, options) {
        return (0,cjs.lastValueFrom)(_createOrReplace(this, index_browser_privateGet(this, _httpRequest2), document, options));
    }
    delete(selection, options) {
        return (0,cjs.lastValueFrom)(_delete(this, index_browser_privateGet(this, _httpRequest2), selection, options));
    }
    mutate(operations, options) {
        return (0,cjs.lastValueFrom)(_mutate(this, index_browser_privateGet(this, _httpRequest2), operations, options));
    }
    /**
   * Create a new buildable patch of operations to perform
   *
   ...
   */ request(options) {
        return (0,cjs.lastValueFrom)(_request(this, index_browser_privateGet(this, _httpRequest2), options));
    }
    /**
   ...
   */ dataRequest(endpoint, body, options) {
        return (0,cjs.lastValueFrom)(_dataRequest(this, index_browser_privateGet(this, _httpRequest2), endpoint, body, options));
    }
    /**
   * Get a Sanity API URL for the URI provided
   *
...
var lodash_isplainobject = __webpack_require__(52620);
// EXTERNAL MODULE: ./node_modules/@vercel/stega/dist/index.js
var dist = __webpack_require__(39932);
